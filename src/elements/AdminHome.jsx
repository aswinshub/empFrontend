      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead style={{backgroundColor:'black'}}>
          <TableRow>
            ...
            <TableCell style={{color:'white'}} align="right">Position</TableCell>
            <TableCell style={{color:'white'}} align="right">Location</TableCell>
            <TableCell style={{color:'white'}} align="right">Delete</TableCell>
            <TableCell style={{color:'white'}} align="right">Update</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
        {data.map((val,i)=>(
